...
@objc(UnlockPasswordReminderViewController)
public class UnlockPasswordReminderViewController: OWSViewController {
    ...
    override public func loadView() {
        ...
        titleLabel.text = NSLocalizedString("PASSWORD_REMINDER_TITLE", comment: "The title for the 'password reminder' dialog.")
        ...
        explanationLabel.accessibilityIdentifier = "passwordReminder.explanationLabel"
        explanationLabel.text = NSLocalizedString("PASSWORD_REMINDER_EXPLANATION", comment: "The explanation for the 'password reminder' dialog.")
        ...
        pinTextField.accessibilityIdentifier = "passwordReminder.pinTextField"
        ...
        validationWarningLabel.accessibilityIdentifier = "passwordReminder.validationWarningLabel"
...
//        dismissButton.autoPinEdge(toSuperviewEdge: .top, withInset: 8)
    ...
    @objc func forgotPressed() {
        ...
        let vc = UnlockPasswordSetupViewController(mode: .recreating) { [weak self] _, _ in
    ...
    private func updateValidationWarnings() {
        ...
        case .tooShort:
            validationWarningLabel.text = NSLocalizedString("PASSWORD_REMINDER_TOO_SHORT_ERROR",
                                                            comment: "Label indicating that the attempted PASSWORD is too short")
        case .mismatch:
            validationWarningLabel.text = NSLocalizedString("PASSWORD_REMINDER_MISMATCH_ERROR",
                                                            comment: "Label indicating that the attempted PASSWORD does not match the user's PASSWORD")
        default:
            break
        }
    }
...
private class UnlockPasswordReminderPresentationController: UIPresentationController {
...
extension UnlockPasswordReminderViewController: UIViewControllerTransitioningDelegate {
    public func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        return UnlockPasswordReminderPresentationController(presentedViewController: presented, presenting: presenting)
    }
}

// MARK: -

extension UnlockPasswordReminderViewController: UITextFieldDelegate {
