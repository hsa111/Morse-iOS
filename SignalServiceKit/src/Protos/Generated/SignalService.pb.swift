...
struct SignalServiceProtos_DataMessage {
  ...
  struct Delete {
    ...
    var authorNumber: String {
      get {return _authorNumber ?? String()}
      set {_authorNumber = newValue}
    }
    /// Returns true if `authorNumber` has been explicitly set.
    var hasAuthorNumber: Bool {return self._authorNumber != nil}
    /// Clears the value of `authorNumber`. Subsequent reads from it will return its default value.
    mutating func clearAuthorNumber() {self._authorNumber = nil}
    ...
    fileprivate var _authorNumber: String? = nil
  }
...
extension SignalServiceProtos_DataMessage.Delete: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self._authorNumber) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._authorNumber {
      try visitor.visitSingularStringField(value: v, fieldNumber: 2)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: SignalServiceProtos_DataMessage.Delete, rhs: SignalServiceProtos_DataMessage.Delete) -> Bool {
    ...
    if lhs._authorNumber != rhs._authorNumber {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
